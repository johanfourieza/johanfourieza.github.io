...
- Downloadable working papers live in files/wp/ (Quarto copies them to
  ...
  and only papers at Submitted, R&R or Accepted get one. Keep the version
  marker in the filename but NEVER show it in the link text:
    · [Working paper](files/wp/JF_WritingIsNot_v3.pdf) \| [Supplementary file](files/wp/JF_WritingIsNot_sup_v3.pdf)
...
::: {.papers}
-   [Accepted]{.pill .pill-accepted} **The New Economics of Cape Slavery** · *South African Journal of Economics* · [Working paper](files/wp/JF_TheNewEconomics_v1.pdf)
-   [R&R]{.pill .pill-rr} **Selection into the Great Trek** [with Calumet Links]{.with} · *European Review of Economic History* · [Working paper](files/wp/JF_CL_SelectionIntoThe_v1.pdf)
:::
...
-   [Submitted]{.pill .pill-submitted} **Protest from Above: Elite Decoupling and Public Petitioning in the VOC Cape Colony** [with Jonathan Schoots]{.with} · [Working paper](files/wp/JS_JF_ProtestFromAbove_v1.pdf) \| [Supplementary file](files/wp/JS_JF_ProtestFromAbove_sup_v1.pdf)
...
-   [Submitted]{.pill .pill-submitted} **Babies as Industrial Policy** · [Working paper](files/wp/JF_BabiesAsIndustrial_v1.pdf)
...
-   [Submitted]{.pill .pill-submitted} **Do Cricket Captains Maximise Winning? Evidence from 125 Years of the Follow-On Rule**
...
::: {.papers}
-   [R&R]{.pill .pill-rr} **Path Dependence in Economic History Publications** · *Cliometrica* · [Working paper](files/wp/JF_TestingForPath_v1.pdf)
...
::: {.papers}
-   [Submitted]{.pill .pill-submitted} **Writing Is Not Thinking** · [Working paper](files/wp/JF_WritingIsNot_v3.pdf) \| [Supplementary file](files/wp/JF_WritingIsNot_sup_v3.pdf)
...
::: {.papers}
-   [Submitted]{.pill .pill-submitted} **Uprooted: Migration, Coercion, and the Roots of Social Connectedness** · [Working paper](files/wp/JF_UprootedMigrationCoercion_v1.pdf) \| [Supplementary file](files/wp/JF_UprootedMigrationCoercion_sup_v1.pdf)
...
Refereeing rarely shows up on a CV. In 2026 I have written reports for *Economics & Human Biology*, *The Economic History Review*, the *European Review of Economic History*, the *Journal of Comparative Economics*, the *Journal of Institutional Economics*, *Social Science History* and *World Development*.

I also serve on the editorial boards of the *Journal of Comparative Economics* and *The History of the Family*.
