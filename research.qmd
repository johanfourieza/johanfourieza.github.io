...
- Downloadable working papers live in files/wp/ (Quarto copies them to
  docs/files/wp/ on render). They are staged by Johan in
  0Claude0\1Research\WorkingPapers as {Initials}_{TitleWords}[_sup]_v{N}.pdf,
  and only papers at Submitted, R&R or Accepted get one. Every paper is two
  files: the .pdf for people and a .md twin of the same stem for AI assistants
  and crawlers. Both are published and both are linked, the named link to the
  PDF and a bare (md) straight after it. Keep the version marker in the
  filename but NEVER show it in the link text:
    · [Working paper](files/wp/JF_WritingIsNot_v3.pdf) [(md)](files/wp/JF_WritingIsNot_v3.md) \| [Supplementary file](files/wp/JF_WritingIsNot_sup_v3.pdf) [(md)](files/wp/JF_WritingIsNot_sup_v3.md)
  A _sup file is the supplement; omit that half of the pair when absent.
  Where a row could carry either a local PDF or an external link (SUN
  wpapers, arXiv, QUCEH), show whichever is the more recent version.
...
::: {.pipeline-glance}
**31 papers in the pipeline:** [8 drafts]{.pill .pill-draft} [15 submitted]{.pill .pill-submitted} [5 R&R]{.pill .pill-rr} [3 accepted]{.pill .pill-accepted}
:::
...
::: {.papers}
-   [Accepted]{.pill .pill-accepted} **The New Economics of Cape Slavery** · *South African Journal of Economics* · [Working paper](files/wp/JF_TheNewEconomics_v1.pdf) [(md)](files/wp/JF_TheNewEconomics_v1.md)
-   [Accepted]{.pill .pill-accepted} **Selection into the Great Trek** [with Calumet Links]{.with} · *European Review of Economic History* · [Working paper](files/wp/JF_CL_SelectionIntoThe_v1.pdf) [(md)](files/wp/JF_CL_SelectionIntoThe_v1.md)
:::
...
::: {.papers}
-   [R&R]{.pill .pill-rr} **Between Public Duty and Private Profit: Government Officials and Real Estate Investments in the Cape Colony, 1897–1902** [with Munashe Chideya]{.with} · *Enterprise & Society* · [Working paper](https://www.ekon.sun.ac.za/wpapers/2026/wp022026)
-   [R&R]{.pill .pill-rr} **Biplots and Classification: Measuring Household Economic Systems at the Cape Colony** [with Sugnet Lubbe, Johané Nienkemper-Swanepoel and Dieter von Fintel]{.with} · *Historical Methods*
-   [Submitted]{.pill .pill-submitted} **The Household in a Coercive Society: Evidence from South Africa's Cape Colony** · [Working paper](files/wp/JF_TheHouseholdIn_v1.pdf) [(md)](files/wp/JF_TheHouseholdIn_v1.md)
-   [Submitted]{.pill .pill-submitted} **The Poor Fund as Lender: Church Credit and Agricultural Production in the Cape Colony, 1686–1829** [with Jacques Theron]{.with} · [Working paper](files/wp/JF_JT_ThePoorFund_v1.pdf) [(md)](files/wp/JF_JT_ThePoorFund_v1.md)
-   [Draft]{.pill .pill-draft} **Protest from Above: Elite Decoupling and Public Petitioning in the VOC Cape Colony** [with Jonathan Schoots]{.with} · [Working paper](files/wp/JS_JF_ProtestFromAbove_v1.pdf) [(md)](files/wp/JS_JF_ProtestFromAbove_v1.md) \| [Supplementary file](files/wp/JS_JF_ProtestFromAbove_sup_v1.pdf) [(md)](files/wp/JS_JF_ProtestFromAbove_sup_v1.md)
-   [Draft]{.pill .pill-draft} **Selection Bias in Probate Inventories** [with Anne McCants and Leoné Walters]{.with}
:::

<details class="pubs">
<summary>Published work (15)</summary>

-   Walters, Leoné, Jonathan Schoots, and Johan Fourie. 2026. "Prices and Living Standards: Evidence from Cape Colony Auction Rolls." *Cliometrica*. [Paper](https://rdcu.be/fvJaI)
...
::: {.papers}
-   [Submitted]{.pill .pill-submitted} **When Do Colonial Institutions Persist? Evidence from Two School Systems in South Africa** [with Sarah Ferber and Gabriel Brown]{.with} · [Working paper](files/wp/SF_EtAl_WhenDoColonial_v1.pdf) [(md)](files/wp/SF_EtAl_WhenDoColonial_v1.md)
-   [Submitted]{.pill .pill-submitted} **Unequal Terms: Ethnic Discrimination in Contract Allocation** [with Kris Inwood and Martine Mariotti]{.with}
-   [Draft]{.pill .pill-draft} **Reconfiguring the Colour Bar: Legal Reform and Occupational Persistence under Apartheid** [with Timothy Ngalande]{.with}
:::
...
-   [Draft]{.pill .pill-draft} **Babies as Industrial Policy**
...
-   [Submitted]{.pill .pill-submitted} **The Decline of the Follow-On in 125 Years of First-Class Cricket** · [Working paper](files/wp/JF_TheDeclineOf_v1.pdf) [(md)](files/wp/JF_TheDeclineOf_v1.md) \| [Supplementary file](files/wp/JF_TheDeclineOf_sup_v1.pdf) [(md)](files/wp/JF_TheDeclineOf_sup_v1.md)
-   [Submitted]{.pill .pill-submitted} **Hunting in Pairs: Testing for Coworker Effects in Professional Cricket** · [Working paper](files/wp/JF_HuntingInPairs_v2.pdf) [(md)](files/wp/JF_HuntingInPairs_v2.md)
-   [Draft]{.pill .pill-draft} **Gates and Menus: Self-Financing Quality in Fragmented Tourism Destinations**
:::
...
::: {.papers}
-   [Accepted]{.pill .pill-accepted} **Path Dependence in Economic History Publications** · *Cliometrica* · [Working paper](files/wp/JF_TestingForPath_v2.pdf) [(md)](files/wp/JF_TestingForPath_v2.md)
-   [R&R]{.pill .pill-rr} **Through the Prism of the Past: Principles for Applied Economic History** [with Chris Colvin]{.with} · *Explorations in Economic History* · [Working paper](https://www.quceh.org.uk/working-papers-2026.html)
-   [Submitted]{.pill .pill-submitted} **LLMs and Economic History: A Comment on Ferrara (2026)**
:::

<details class="pubs">
<summary>Published work (4)</summary>

-   Fourie, Johan. 2026. "From Renaissance to Relevance: Towards an Applied African Economic History." *Economic History of Developing Regions*. [Paper](https://www.tandfonline.com/doi/full/10.1080/20780389.2026.2707070)
...
::: {.papers}
-   [Submitted]{.pill .pill-submitted} **Writing Is Not Thinking** · [Working paper](files/wp/JF_WritingIsNot_v3.pdf) [(md)](files/wp/JF_WritingIsNot_v3.md) \| [Supplementary file](files/wp/JF_WritingIsNot_sup_v3.pdf) [(md)](files/wp/JF_WritingIsNot_sup_v3.md)
-   [Submitted]{.pill .pill-submitted} **The Value of Peer Review and the Reward to Reputation** · [Working paper](files/wp/JF_ValueOfPeer_v5.pdf) [(md)](files/wp/JF_ValueOfPeer_v5.md)
-   [Submitted]{.pill .pill-submitted} **The Price of Submission** · [Working paper](files/wp/JF_ThePriceOf_v1.pdf) [(md)](files/wp/JF_ThePriceOf_v1.md)
-   [Submitted]{.pill .pill-submitted} **The Scientist in the Machine Age** · [Working paper](files/wp/JF_TheScientistIn_v2.pdf) [(md)](files/wp/JF_TheScientistIn_v2.md)
-   [Draft]{.pill .pill-draft} **AI and the Research Team**
-   [Draft]{.pill .pill-draft} **How Much of AI Progress Reaches Production? Evidence from Agent Commits on Public GitHub** [with Friedrich Kreuser]{.with}
:::
:::
...
::: {.papers}
-   [R&R]{.pill .pill-rr} **Uprooted: Migration, Coercion, and the Roots of Social Connectedness** · *Economic Inquiry* · [Working paper](files/wp/JF_UprootedMigrationCoercion_v1.pdf) [(md)](files/wp/JF_UprootedMigrationCoercion_v1.md) \| [Supplementary file](files/wp/JF_UprootedMigrationCoercion_sup_v1.pdf) [(md)](files/wp/JF_UprootedMigrationCoercion_sup_v1.md)
-   [Submitted]{.pill .pill-submitted} **Bulky: Commodity Booms and Shared Transport Capacity**
:::
...
Refereeing rarely shows up on a CV. I have written reports for the *Quarterly Journal of Economics*, the *Review of Economics and Statistics*, *The Economic Journal*, the *Journal of Economic Growth*, the *Journal of Development Economics* and the *Journal of Economic History*, among many others, and for nine journals in 2026 alone.
