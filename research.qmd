...
::: {.pipeline-glance}
**29 papers in the pipeline:** [9 drafts]{.pill .pill-draft} [16 submitted]{.pill .pill-submitted} [3 R&R]{.pill .pill-rr} [1 accepted]{.pill .pill-accepted}
:::
...
-   [Submitted]{.pill .pill-submitted} **Protest from Above: Elite Decoupling and Public Petitioning in the VOC Cape Colony** [with Jonathan Schoots]{.with} · [Working paper](files/wp/JS_JF_ProtestFromAbove_v1.pdf) [(md)](files/wp/JS_JF_ProtestFromAbove_v1.md) \| [Supplementary file](files/wp/JS_JF_ProtestFromAbove_sup_v1.pdf) [(md)](files/wp/JS_JF_ProtestFromAbove_sup_v1.md)
...
::: {.papers}
-   [Submitted]{.pill .pill-submitted} **Uprooted: Migration, Coercion, and the Roots of Social Connectedness** · [Working paper](files/wp/JF_UprootedMigrationCoercion_v1.pdf) [(md)](files/wp/JF_UprootedMigrationCoercion_v1.md) \| [Supplementary file](files/wp/JF_UprootedMigrationCoercion_sup_v1.pdf) [(md)](files/wp/JF_UprootedMigrationCoercion_sup_v1.md)
