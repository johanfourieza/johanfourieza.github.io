...
::: {.pipeline-glance}
**30 papers in the pipeline:** [7 drafts]{.pill .pill-draft} [17 submitted]{.pill .pill-submitted} [5 R&R]{.pill .pill-rr} [1 accepted]{.pill .pill-accepted}
:::
...
-   [R&R]{.pill .pill-rr} **Selection into the Great Trek** [with Calumet Links]{.with} · *European Review of Economic History* · [Working paper](files/wp/JF_CL_SelectionIntoThe_v1.pdf) [(md)](files/wp/JF_CL_SelectionIntoThe_v1.md)
:::
...
-   [Draft]{.pill .pill-draft} **Discrimination After Hiring: Within-Firm Sorting, Slow Employer Learning, and the Cost to the Sorted Worker** [with Kris Inwood and Martine Mariotti]{.with}
...
-   [Submitted]{.pill .pill-submitted} **Babies as Industrial Policy** · [Working paper](files/wp/JF_BabiesAsIndustrial_v1.pdf) [(md)](files/wp/JF_BabiesAsIndustrial_v1.md)
...
-   [Submitted]{.pill .pill-submitted} **Hunting in Pairs: Testing for Coworker Effects in Professional Cricket** · [Working paper](files/wp/JF_HuntingInPairs_v1.pdf) [(md)](files/wp/JF_HuntingInPairs_v1.md)
...
::: {.papers}
-   [R&R]{.pill .pill-rr} **Testing for Path Dependence in Economic History Publications** · *Cliometrica* · [Working paper](files/wp/JF_TestingForPath_v2.pdf) [(md)](files/wp/JF_TestingForPath_v2.md)
...
-   [Submitted]{.pill .pill-submitted} **AI and the Research Team** · [Working paper](files/wp/JF_AIAndThe_v1.pdf) [(md)](files/wp/JF_AIAndThe_v1.md) \| [Supplementary file](files/wp/JF_AIAndThe_sup_v1.pdf) [(md)](files/wp/JF_AIAndThe_sup_v1.md)
