...
::: {.pipeline-glance}
**31 papers in the pipeline:** [10 drafts]{.pill .pill-draft} [16 submitted]{.pill .pill-submitted} [4 R&R]{.pill .pill-rr} [1 accepted]{.pill .pill-accepted}
:::
...
::: {.papers}
-   [R&R]{.pill .pill-rr} **Path Dependence in Economic History Publications** · *Cliometrica* · [Working paper](files/wp/JF_TestingForPath_v1.pdf) [(md)](files/wp/JF_TestingForPath_v1.md)
...
-   [Draft]{.pill .pill-draft} **Messy Review: Certification Value and the Return to Pedigree** · [Working paper](files/wp/JF_MessyReviewCertification_v1.pdf) [(md)](files/wp/JF_MessyReviewCertification_v1.md)
