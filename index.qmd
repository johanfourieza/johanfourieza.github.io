...
<script>
fetch("https://api.allorigins.win/raw?url=" + encodeURIComponent("https://www.ourlongwalk.com/feed"))
  .then(r => r.text())
  .then(xml => {
    var doc = new DOMParser().parseFromString(xml, "text/xml");
    var items = doc.querySelectorAll("item");
    var el = document.getElementById("substack-posts");
    for (var i = 0; i < 3 && i < items.length; i++) {
      ...
      card.innerHTML =
        ...
        '<div class="substack-card-body">' +
          '<p class="substack-card-title">' + title + '</p>' +
